...
#SBATCH --job-name=mart_k5_curriculum
...
python main_nba_pt.py \
    --config configs/mart_nba_aug_k5.yaml \
    --split_path ../../splits/fold0.json \
    --model_name mart_k5_curriculum_2k \
    --num_epochs 2000 \
    --iso_norm \
    --aug_rot_deg 180 \
    --aug_court_mirror \
    ...
    --loss min_ade \
    --curriculum \
    --curriculum_switch 600 \
    --gpu 0 \
    --wandb_run_name mart_k5_curriculum_2k \
