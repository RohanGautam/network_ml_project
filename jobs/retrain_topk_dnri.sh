...
STUDY_PATH="$HOME/network_ml_project/optuna_studies/dnri.db"

cd $SCRATCH/network_ml_project
source $HOME/network_ml_project/.venv/bin/activate

python src/dynamic/retrain_topk.py \
...
mkdir -p $HOME/network_ml_project/submissions $HOME/network_ml_project/models/dnri_topk
rsync -a $SCRATCH/network_ml_project/submissions/ $HOME/network_ml_project/submissions/
rsync -a $SCRATCH/network_ml_project/models/dnri_topk/ $HOME/network_ml_project/models/dnri_topk/
